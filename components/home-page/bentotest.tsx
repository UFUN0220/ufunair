...
const Bentotest: React.FC = () => {
  const Klayimg = '/static/images/Klay_home2.png'
  const cutegif = '/static/images/cute.gif'
  const jsu = '/static/images/jsu_home2.jpg'
  const washu = '/static/images/washu_home.jpg'
  const stl = '/static/images/stl_home.png'
  const test = '/static/images/ujs_home.jpg'
  const bigbg = '/static/images/bigbg.jpg'
  const qingdao = '/static/images/qingdao_home2.jpg'
  const starsky = '/static/images/washu_sky.jpg'
  const logo = '/static/images/logo.jpg'
  // const xinxin = '/static/images/xinxin.jpg';
  const color = '/static/images/bigbg.png'
